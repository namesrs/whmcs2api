...
function namesrs_TransferDomain($params)
{
  try
  {
    ...
    $result = $api->request('POST','/domain/create_domain_transfer', Array('domainname' => $api->domainName, 'auth' => $params['eppcode'], 'custom_field' => $params['domainid'], 'DNSid' => $params['DNS_id']));
